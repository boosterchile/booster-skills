...
references:
  - ADR-001 stack canónico
  - ADR-005 telemetría IoT
  - skill incident-response (runbook scaffolding)
  - skill booster-stack-conventions (Zod, Biome, Logger, OTel)
  - skill booster-deploy-cloud-run (deploy flow)
---
